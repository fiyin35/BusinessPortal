...
const EditBusinessForm = () => {
    let initialValues: NewBizValues = {
        firstName: "Eniola",
        lastName: "Adegbuyi",
        email: "hey.mayorxo@gmail.com",
        phoneNumber: "234 906 6216 280",
        bizName: "Tech Hack",
        state: "1",
        address: "10, Alhaji muniru close, Bode Thomas",
        account: "0018921092",
    }
    ...
    return (
        <div className="form-wrap for-cards">
            <Formik
                ...
                onSubmit={(values: NewBizValues, actions) => {
...
const EditBUsinessWrap = () => {
    return (
        <div className=" card-wrap">
            <div className="card-heading with-border">
                <div className="bolden-title">Edit Business</div>
            </div>
            <EditBusinessForm />
...
export const EditBusiness = () => {
    ...
    let breadcrumbs = "Edit Business"
    return (
        <InAppTemplate activeBreadcrumbs={true} breadcrumbs={breadcrumbs} hasSearchBar={false} pageHeadingTitle="Business Registration" childComponent={<FormContentWrap {...screenResolution} />} />
    )
}